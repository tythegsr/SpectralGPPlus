...
class MultifidelityLikelihood(_GaussianLikelihoodBase):
    ...
    def __init__(
        self,
        fidel_indices: Tensor,
        noise_indices: list = [1],
        noise_prior=None,
        ...
        **kwargs,
        ...
        num_noises = len(noise_indices)
        noise_covar = MultifidelityNoise(
            noise_prior=noise_prior, noise_constraint=noise_constraint, batch_shape=batch_shape, num_noises=num_noises
        )
