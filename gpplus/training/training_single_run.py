...
class GPTrainerSingleProcess:
    ...
    def _train_standard_epoch(self, optimizer, mll):
        ...
        # Enforce parameter constraints after optimizer step
    ...
    def _lbfgs_closure(self, model, optimizer, mll):
        ...
        def closure():
            ...
            # Enforce parameter constraints after gradient computation
            # This prevents parameters from going out of bounds during LBFGS internal steps
