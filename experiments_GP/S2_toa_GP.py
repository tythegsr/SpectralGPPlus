...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="S2 11-QoI TOA with exact GP (dense)")
    ...
    parser.add_argument("--noise-prior-log-scale", type=float, default=0.1)
    ...
    save_path = args.save_path or "experiments_GP/results/s2_toa_gp"
