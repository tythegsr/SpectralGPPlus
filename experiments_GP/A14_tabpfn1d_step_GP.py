"""1D 4-step piecewise constant benchmark with GPPlus exact GP."""
...
def run_tabpfn1d_step_gp(
    ...
    save_path: str | None = "experiments_GP/results/tabpfn1d_step_gp",
    ard: bool = True,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="1D step function with GPPlus exact GP")
    ...
    parser.add_argument("--save-path", type=str, default="experiments_GP/results/tabpfn1d_step_gp")
    args = parser.parse_args()

    gpplus.config.configure_logger()
    run_tabpfn1d_step_gp(
