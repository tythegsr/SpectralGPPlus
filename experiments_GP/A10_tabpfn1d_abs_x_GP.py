"""1D f(x)=|x| benchmark with GPPlus exact GP."""
...
def run_tabpfn1d_abs_x_gp(
    ...
    save_path: str | None = "experiments_GP/results/tabpfn1d_abs_x_gp",
    ard: bool = True,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="1D |x| with GPPlus exact GP")
    ...
    parser.add_argument("--save-path", type=str, default="experiments_GP/results/tabpfn1d_abs_x_gp")
    args = parser.parse_args()

    gpplus.config.configure_logger()
    run_tabpfn1d_abs_x_gp(
