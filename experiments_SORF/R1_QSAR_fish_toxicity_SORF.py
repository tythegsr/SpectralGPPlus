"""R1: QSAR fish toxicity with GPPlus SORF (Woodbury)."""
...
# ---------------------------------------------------------------------------
TRAIN_FRAC = 2.0 / 3.0
NUM_RFF: int | None = None # D frequencies; None = min(512, max(64, n_train // 3))
NUM_INITS = 8
...
SAVE_PATH: str | None = "experiments_SORF/results/qsar_fish_toxicity_sorf"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="R1 QSAR fish toxicity SORF")
