...
RESULTS_ROOT = Path("experiments_SORF/results/orf_batch")
PLOT_OUTPUT_DIR = Path("experiments_SORF/results/orf_batch/plots")
...
def _extract_validation_block(metrics: dict) -> dict[str, list[dict]] | None:
    """Top-level or nested under sorf_metrics (wing vs TabPFN combined results)."""
