"""R4: Airfoil self-noise with GPPlus SORF (Woodbury)."""
...
SAVE_PATH: str | None = "experiments_SORF/results/airfoil_self_noise_sorf"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="R4 airfoil self-noise SORF")
