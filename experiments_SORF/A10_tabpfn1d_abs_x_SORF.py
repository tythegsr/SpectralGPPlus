"""1D f(x)=|x| benchmark with GPPlus SORF kernel."""
...
def run_tabpfn1d_abs_x_sorf(
    ...
    save_path: str | None = "experiments_SORF/results/tabpfn1d_abs_x_rff",
    ard: bool = True,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="1D |x| with GPPlus SORF")
    ...
    parser.add_argument("--save-path", type=str, default="experiments_SORF/results/tabpfn1d_abs_x_rff")
    args = parser.parse_args()

    gpplus.config.configure_logger()
    run_tabpfn1d_abs_x_sorf(
