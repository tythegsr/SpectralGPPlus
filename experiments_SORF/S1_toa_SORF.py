"""TOA benchmark with GPPlus SORF kernel (Woodbury inference)."""
...
from toa_sorf_base import run_toa_sorf


def run_toa_sorf_entry(**kwargs) -> dict:
    return run_toa_sorf(**kwargs)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=200,
        help="D (SORF frequencies); default min(512, n_train//3)",
    )
    ...
    parser.add_argument("--save-path", type=str, default="experiments_SORF/results/toa_sorf")
    parser.add_argument(
        "--monitor-validation",
        action="store_true",
