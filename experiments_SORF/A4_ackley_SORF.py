"""
Ackley XXD (XX=number of dimensions) benchmark with GPPlus SORF kernel (Woodbury inference).
...
def run_ackley_40d_sorf(
    ...
    save_path: str | None = "experiments_SORF/results/ackley_40D_sorf",
    ...
    num_sorf : D in RFF (feature dimension m = 2*D). Default: min(512, n_train // 3).
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Ackley 40D with GPPlus SORF (no SEEK)")
    parser.add_argument("--dimensions", type=int, default=10)
    parser.add_argument("--train-size", type=int, default=40, help="train points per dimension")
    parser.add_argument("--num-sorf", type=int, default=2000, help="D (SORF frequencies); default min(512, n_train//3)")
    ...
    parser.add_argument("--save-path", type=str, default="experiments_SORF/results/ackley_test_val")
    parser.add_argument(
        "--no-plot",
        action="store_true",
