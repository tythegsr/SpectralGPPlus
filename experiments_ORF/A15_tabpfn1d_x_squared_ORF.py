"""1D f(x)=x^2 benchmark with GPPlus ORF kernel."""
...
def run_tabpfn1d_x_squared_orf(
    train_size: int = 10,
    ...
    save_path: str | None = "experiments_ORF/results/tabpfn1d_x_squared_rff",
    ard: bool = True,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="1D x^2 with GPPlus ORF")
    ...
    parser.add_argument("--save-path", type=str, default="experiments_ORF/results/tabpfn1d_x_squared_rff")
    args = parser.parse_args()

    gpplus.config.configure_logger()
    run_tabpfn1d_x_squared_orf(
