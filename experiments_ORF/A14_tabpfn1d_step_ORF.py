"""1D 4-step piecewise constant benchmark with GPPlus ORF kernel."""
...
def run_tabpfn1d_step_orf(
    ...
    save_path: str | None = "experiments_ORF/results/tabpfn1d_step_rff",
    ard: bool = True,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="1D step function with GPPlus ORF")
    ...
    parser.add_argument("--save-path", type=str, default="experiments_ORF/results/tabpfn1d_step_rff")
    args = parser.parse_args()

    gpplus.config.configure_logger()
    run_tabpfn1d_step_orf(
