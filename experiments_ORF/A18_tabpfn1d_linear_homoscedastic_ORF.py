"""1D linear f(x)=slope*x+intercept benchmark with GPPlus ORF kernel."""
...
def run_tabpfn1d_linear_homoscedastic_orf(
    train_size: int = 40,
    ...
    save_path: str | None = "experiments_ORF/results/tabpfn1d_linear_homoscedastic_rff",
    ard: bool = True,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="1D linear with GPPlus ORF")
    ...
    parser.add_argument("--save-path", type=str, default="experiments_ORF/results/tabpfn1d_linear_homoscedastic_rff")
    args = parser.parse_args()

    gpplus.config.configure_logger()
    run_tabpfn1d_linear_homoscedastic_orf(
