"""1D f(x)=|x| benchmark with GPPlus RFF kernel."""
...
def run_tabpfn1d_abs_x_rff(
    ...
    save_path: str | None = "experiments_RFF/results/tabpfn1d_abs_x_rff",
    ard: bool = True,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="1D |x| with GPPlus RFF")
    ...
    parser.add_argument("--save-path", type=str, default="experiments_RFF/results/tabpfn1d_abs_x_rff")
    args = parser.parse_args()

    gpplus.config.configure_logger()
    run_tabpfn1d_abs_x_rff(
