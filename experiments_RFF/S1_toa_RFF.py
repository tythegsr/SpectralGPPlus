...
for p in (_ROOT, _RFF_DIR, _MTGPR_DIR):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=1600,
        help="D (RFF frequencies); default: 1600 (min(512, n_train//3) when omitted programmatically)",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Results directory (default: experiments_RFF/results/toa_rff)",
    )
    parser.add_argument(
        "--monitor-validation",
        action="store_true",
    ...
    if save_path is None:
        save_path = "experiments_RFF/results/toa_rff"
